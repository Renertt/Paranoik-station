...
ent-Toolboombox = бумбокс
    .desc = Ярко-красный разукрашенный ящик, поверхность покрыта белёсыми разводами и тёмными пятнами неизвестного происхождения, так же на нём присутствует надпись "Boom Бокс"
