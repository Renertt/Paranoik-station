...
uplink-ToolboxShotgun-name = Ящик аварий синдиката.
uplink-ToolboxShotgun-desc = Раз в год и ящик стреляет. Главное — не стоять перед ним, когда он это решит. Иногда поставщики оставляют что-то полезное. Использует .50 калибр.
